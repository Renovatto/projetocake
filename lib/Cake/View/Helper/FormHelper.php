...
/**
 * Gera um elemento de entrada de formulário completo com rótulo e embalagem div
 *
 * # # # Opções
 *
 * Veja cada método tipo de campo para obter mais informações. Quaisquer opções que fazem parte da
 * Opções * $ $ ou atributos para o tipo diferente ** ** métodos podem ser incluídos em `$` para opções de entrada (). I
 * Além disso, as teclas de desconhecidos que não estão na lista abaixo, ou parte das opções do tipo selecionado
 * Será tratada como um atributo regular html para a entrada gerado.
 *
